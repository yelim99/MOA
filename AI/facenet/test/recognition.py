...
def is_match(known_embedding, candidate_embedding, threshold=10):  # 임계값 조정 가능
...
registered_faces = ['../img/yook5.jpg']
registered_names = ['yook']  # 등록된 얼굴에 대한 이름 리스트
...
# 이미지 파일로 얼굴 감지 및 비교
process_image(yolo_model, facenet_model, registered_embeddings, registered_names, '../img/btob.jpg')
34